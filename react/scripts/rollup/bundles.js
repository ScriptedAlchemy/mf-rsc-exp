...
const RSDW_ROOT = path.resolve(
  __dirname,
  '../../packages/react-server-dom-webpack'
);
const RSDW_CJS_DIST = path.join(RSDW_ROOT, 'dist', 'cjs');
const RSDW_ESM_DIST = path.join(RSDW_ROOT, 'dist', 'esm');
...
const bundles = [
  ...
  /******* React Server DOM Webpack Node.js Loader *******/
  {
    ...
    moduleType: RENDERER_UTILS,
    entry: 'react-server-dom-webpack/src/ReactFlightWebpackNodeLoader',
    condition: 'react-server',
    outputDir: RSDW_ESM_DIST,
